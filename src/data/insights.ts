...
export const posts: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Our tax team monitors ATO communications and rulings closely throughout the year. If any of these focus areas are relevant to your situation, we recommend a proactive review now. Acting before an audit is initiated is almost always less costly, both financially and in management time, than responding to one.",
    ],
  },
  {
